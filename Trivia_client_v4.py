...
def recv_message_and_parse(conn) -> Tuple[str, str]:
	"""
...
def main():
	...
	try:
		...
		while True:
			...
			# The GamePlay client <-> server communication


		# Signing out from the game
		# logout(conn)

	except ConnectionResetError:
		exit_the_game(conn)
		print('The game crushed due to server problem')
		return
