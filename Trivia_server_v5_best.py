...
# server.py
"""
new func! dispose_dead_client() add to overcome the unexpected leaving of client
client_sockets = [] still constant
"""
##############################################################################
import select
import socket
...
def dispose_dead_client(conn : socket.socket):
		try:
			print(f"A client disconnected unexpectedly and has removed from the list.")
